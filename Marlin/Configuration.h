...
//En kuttercraft cambiamos de productor de motores estos tiene otros valores
//las maquinas mas nuevas traen motor con ficha
//#define FICHA_MOTOR
...
#define NUMERO_DE_VERCION_ACTUAL "5.3.7/12v"
...
// Author info of this build printed to the host during boot and M115
  ...
  #define STRING_CONFIG_H_AUTHOR "(Kuttercraft, SKR 2)" // Who made the changes.
#else
  #define STRING_CONFIG_H_AUTHOR "(Kuttercraft, SKR 1.4)" // Who made the changes.
#endif
...
//#define HOTEND_OFFSET_X { 10.0, 0.0 } // (mm) relative X-offset for each nozzle
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 12, 30 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 120*3, 120*3, 10, 50 } // ...or, set your own edit limits
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 1000*3, 1000*3, 200, 20000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 44, -44, -1.3 }
#define OFFSET_HOTEND_G "G91\nG1 X44 Y-44 F2000\nG90"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT  0.36 // (mm) Default layer height for G26.
...
#define HOMING_FEEDRATE_MM_M { (1500), (1500), (400) }
