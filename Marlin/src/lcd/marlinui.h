...
public:
  ...
  static void clear_lcd();
    ...
    static void reset_alert_level() {}
      ...
      static char texto_muy_largo[100];
      static char numero_de_serie[16];
      static int encoder_giro;

      static char capa_actual[20];
      ...
      static bool sensor_filamento_on_off;
      ...
      static float offset_temporal;

      static bool home_en_accion;
      ...
      static char list_layer[20][8];
      
      static int layer_pointer_memory;

      static int  m600_espera_cura;
      static bool m600_waiting_filament_change;

      static bool invertir_motor_x;

      static bool salida_de_G29;

      static bool salida_de_G26;

      static int modo_de_impresion;

      static bool fan_prueba_pid;

      static bool calibracion_general_valor;

      static uint8_t que_eje_hace_home;

      static bool calibrando_sensibilidad;
      static bool salida_calibrando_sensibilidad;
      static bool sensibilidad_primera_parte;

      static bool salida_M117;
