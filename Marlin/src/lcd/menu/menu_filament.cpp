...
#define HOTEND_STATUS_ITEM() do { \
  ...
  void cargar(){
    MarlinUI::retirar_o_cargar = 1;
    pause_menu_response = PAUSE_RESPONSE_EXTRUDE_MORE;
  }
  void retirar(){
    MarlinUI::retirar_o_cargar = 2;
    pause_menu_response = PAUSE_RESPONSE_EXTRUDE_MORE;
  }
...
void lcd_pause_changing_message() { _lcd_pause_message(GET_TEXT(MSG_FILAMENT_CHANGE_K_CARGA));   }
...
void lcd_pause_insert_message()   { _lcd_pause_message(GET_TEXT(MSG_FILAMENT_CHANGE_K_RETIRAR)); }
