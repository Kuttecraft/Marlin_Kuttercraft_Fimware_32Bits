...
void menu_configuration();
  ...
  void menu_main() {
    ...
    //tama�o del boton, espacio entre botones, cantidas de botones por fila, altura del boton
    init_boto(23, 2, 5, 2);
    ...
    if (!esta_imprimiendo && !printingIsPaused()) {
      ...
      crear_boton(boton_filamento_a,  boton_filamento_b, Language_es::MSG_FILAMENT,         ajuste_de_filamento);  

      crear_boton(boton_Temp_a,       boton_Temp_b,      Language_es::MSG_TEMPERATURE,      temperatura_preset_manual);
      
      //leveling_active se combierte en falso cuando se hace un home
      //por eso hay que agregar el "or"
      if(planner.leveling_active || MarlinUI::inductivo_final_carrera){
        crear_boton(calibrar_offset_a,  calibrar_offset_b, Language_es::MSG_AUTO_CALIBRATE_000, menu_kutter_calibracion_con_sensor);  //El menu de auto-calibracion
      }else{
        crear_boton(boton_hotend_a,     boton_hotend_b,    Language_es::MSG_CALIBRATE,          menu_calibracion_endstop);            //El munu de calibracion con endstop
      }
      ...
      crear_boton(boton_ajustes_a,    boton_ajustes_b,   Language_es::MSG_TUNE,             menu_ajustes);               //muestra una lista de opciones configurables


    }else{
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////|Menu Mientras Se  Imprime|/////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
